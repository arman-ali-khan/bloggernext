...
const userId = () => {
 ...
 useEffect(() => {
  ...
  return (
     <Layout title={'User Profile'} description={'Profile of Arman Ali Khan'} thumb={'userphoto'}>
        ...
        <div className="bg-white rounded-lg shadow-xl pb-8">
          ...
          >
            <div className="dropdown dropdown-end flex">
              <label
                tabIndex={0}
                className="border w-full border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20"
                title="Settings"
              >
                <svg
              ...
              >
                ...
                <CopyToClipboard text={`https://bloggernext.vercel.app/@${id}`}>
                  <button onClick={()=>{toast.success('copy to clipboard')}} className="w-full flex items-center px-6 py-1.5 space-x-2 hover:bg-gray-200">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-col items-center -mt-20">
            <img
              src={user?.photo}
              className="w-40 border-4 h-40 bg-blue-100 bg-opacity-50 border-blue-300 object-cover object-center rounded-full"
            />
              ...
              <div className="relative px-4">
                ...
                <div className="flex items-center w-full my-6 -ml-1.5">
                  ...
                  <div className="w-11/12">
                    <div className="text-sm">Profile informations changed.</div>
                ...
                <div className="flex items-center w-full my-6 -ml-1.5">
                  ...
                  <div className="w-11/12">
                    ...
                    <div className="text-xs text-gray-500">57 min ago</div>
                  </div>
                </div>
                {/* <!-- end::Timeline item --> */}
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-8 mt-8">
            ...
            >
              ...
              />
              <span className="text-center font-bold text-sm mt-1">Diane Aguilar</span>
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Frances Mather</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Carlos Friedrich</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Donna Serrano</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Randall Tabron</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">John McCleary</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Amanda Noble</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Christine Drew</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Lucas Bell</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Debra Herring</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Benjamin Farrior</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Maria Heal</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Edward Ice</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Jeffery Silver</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Jennifer Schultz</span>
              <span className="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                className="w-16 rounded-full"
              />
              <span className="text-center font-bold text-sm mt-1">Joseph Marlatt</span>
              <span className="text-xs text-gray-500 text-center">
