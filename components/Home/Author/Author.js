...
<div className="font-sans leading-tight bg-grey-lighter ">
    <div className="w-full md:max-w-sm bg-white rounded-lg flex flex-col sm:flex-row items-center sm:justify-between justify-center md:block overflow-hidden shadow-lg">
        <div className="border-b px-2 pb-6 w-full">
            <div className="text-center sm:text-left flex items-center mb-4">
                ...
                <div className="py-2">
                    ...
                    <div className="inline-flex text-grey-dark sm:flex items-center">
                        <svg className="h-5 w-5 text-grey mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex">
                <button className="flex-1 rounded-full bg-blue text-black antialiased font-bold hover:bg-blue-dark px-4 py-2 mr-2 border-2">Follow</button>
