        ...
        <div class="bg-white rounded-lg shadow-xl pb-8">
          ...
          >
            <div className="dropdown dropdown-end flex">
              <label
                tabIndex={0}
                class="border w-full border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20"
                title="Settings"
              >
                <svg
            ...
            <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
              ...
              <div class="relative px-4">
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                  ...
                  <div class="w-11/12">
                    <div class="text-sm">Profile informations changed.</div>
                    <div class="text-xs text-gray-500">3 min ago</div>
                  </div>
                </div>
                {/* <!-- end::Timeline item --> */}
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                  ...
                  <div class="w-11/12">
                    <div class="text-sm">
                      Connected with{" "}
                      <Link href="#" class="text-blue-600 font-bold">
                        Colby Covington
                      </Link>
                      .
                    </div>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5">
                  ...
                  <div class="w-11/12">
                    ...
                    <div class="text-xs text-gray-500">57 min ago</div>
                  </div>
                </div>
                {/* <!-- end::Timeline item --> */}
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-8 mt-8">
            ...
            >
              ...
              />
              <span class="text-center font-bold text-sm mt-1">Diane Aguilar</span>
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Frances Mather</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Carlos Friedrich</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Donna Serrano</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Randall Tabron</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">John McCleary</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Amanda Noble</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Christine Drew</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Lucas Bell</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Debra Herring</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Benjamin Farrior</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Maria Heal</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Edward Ice</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Jeffery Silver</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Jennifer Schultz</span>
              <span class="text-xs text-gray-500 text-center">
            ...
            >
              <img
                ...
                class="w-16 rounded-full"
              />
              <span class="text-center font-bold text-sm mt-1">Joseph Marlatt</span>
              <span class="text-xs text-gray-500 text-center">
