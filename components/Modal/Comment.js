...
<label className='flex absolute top-2 w-7 h-7 justify-center cursor-pointer items-center right-3  bg-gray-600   rounded-full p-1 ' htmlFor="postComment" >
    ...
    <p className="py-2  w-full"></p>
        <form onSubmit={handleSubmit(handlePostComment)} className='my-4 flex-col flex border-b py-2 border-gray-500 md:flex-row gap-2 items-center'>
...
<button className=' md:w-40 btn'>Add Comment</button>
       ...
       { comments.length ?
        comments.map(comment=> <div className='flex my-2 items-center gap-1'>
        <div className='w-12 h-12 flex justify-center'>
            <img src={comment.photo} className='w-12 h-12 rounded-full' alt="" />
        </div>
        <div className='w-full border-b border-gray-600 py-1'>
